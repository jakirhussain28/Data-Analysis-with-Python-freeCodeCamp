...
# 2: Add an overweight column to the data. To determine if a person is overweight, first calculate their 
...
def draw_heat_map():
    ...
    ax = sns.heatmap(corr, linewidths=1, annot=True, fmt='.1f', mask=mask, square=True, center=0.08, cbar_kws={'shrink': .5})
